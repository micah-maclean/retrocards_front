                        ...
                        <KudosProvider>
                            <Routes>
                                <Route element={<PrivateRoute />}>
                                    ...
                                    <Route path="/retrospectiva/:idRetrospective" element={<RetroDetails />} />

                                    <Route element={<Facilitator/>}>
                                       <Route path="/sprint/cadastrar" element={<SprintForm />} />
                                        <Route path="/sprint/editar/:idSprint" element={<SprintForm />} />
                                        <Route path="/retrospectiva/cadastrar/:idSprint" element={<RetroForm />}/>
                                        <Route path="/retrospectiva/editar/:idSprint/:idRetrospective" element={<RetroForm />} />
                                        <Route path="/kudo-box/cadastrar/:idSprint" element={<KudoBoxForm />} />
                                        <Route path="/kudo-box/editar/:idSprint/:idKudoBox" element={<KudoBoxForm />} />
                                        <Route path="/enviar-email/:idRetrospective/:idSprint" element={<SendEmailForm />} /> 
                                    </Route>
                                    
                                    <Route element={<Member/>}>
                                        <Route path="/item/cadastrar/:idRetrospective" element={<ItemRetroForm />}/>
                                        <Route path="/item/editar/:idRetrospective/:idItemRetrospective" element={<ItemRetroForm />} />
                                        <Route path="/kudo-card/cadastrar/:idKudoBox" element={<KudoCardForm />} />
                                        <Route path="/kudo-card/editar/:idKudoBox/:idKudoCard" element={<KudoCardForm />}/>
                                    </Route>

                                    <Route element={<Admin/>}>
                                        <Route path="/users" element={<Users />} />
                                        <Route path="/users/:idUser" element={<UsersForm />}/> 
                                    </Route>
                                </Route>
